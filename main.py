...
# python main.py --LambdaMin 0.36 --LambdaMax 0.36 --LambdaStep 0 --AlphaMin 3.5 --AlphaMax 3.5 --AlphaStep 0 --Begining 125 --SeedSet 10 --UsersToHandle 525 
